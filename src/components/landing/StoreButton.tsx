...
export default function StoreButton({ storeName, label }: StoreButtonProps) {
  return (
    <a
      href="#"
      title="Coming soon"
      className="flex w-full items-center gap-3 rounded-2xl border border-foreground-muted/15 bg-surface px-4 py-3 text-left transition hover:border-brand/30"
    >
