  ...
  return (
    <section id="home" className="relative scroll-mt-20 overflow-hidden bg-background">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-8 lg:py-24 lg:px-8">
        ...
        {/* Telefon, hero'nun sağ yarısının odağı: dikeyde belirgin büyük, gerçek telefona
            yaklaşan bir en-boy oranıyla (~9:17.5, aspect-ratio ile sabitleniyor). İç içerik
            flex+justify-between ile tüm yüksekliğe yayılıp nefes alıyor. Özellikler ayrıca
            anlatılmıyor burada — "Why Flexy" bölümü bu işi zaten yapıyor, hero sade kalsın diye
            sadece başlık + telefon. */}
        <div className="relative mx-auto w-full max-w-[360px] py-6 lg:max-w-none lg:py-4">
          <div className="relative z-10 mx-auto aspect-[9/17.5] w-[300px] sm:w-[360px] lg:w-[420px]">
            ...
            <div className="relative h-full rounded-[3.25rem] border-[10px] border-foreground/10 bg-[#0b0f16] shadow-2xl shadow-black/50">
              ...
              <div className="flex h-full flex-col justify-between overflow-hidden rounded-[2.6rem] bg-surface-raised p-5 pb-7 pt-12">
                ...
                <div className="flex items-center justify-between rounded-xl border border-brand/20 bg-brand/10 px-3.5 py-2.5">
