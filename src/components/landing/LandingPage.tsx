...
import { AuthModalProvider, type AuthMode } from '@/components/auth/AuthModalProvider';
...
type LandingPageProps = {
  // /login veya /register route'undan açılınca ilgili modal baştan açık gelsin diye.
  initialAuthMode?: AuthMode;
};

// Landing sayfasının tüm içeriği burada yaşıyor: hem "/" hem "/login" hem "/register" aynı bu
// bileşeni render eder (sadece initialAuthMode farklı) — böylece login/register "ayrı sayfa"
// değil, landing'in üzerinde açılan bir modal olur, ama URL ile de doğrudan açılabilir.
export default function LandingPage({ initialAuthMode }: LandingPageProps) {
  return (
    <AuthModalProvider initialMode={initialAuthMode ?? null}>
